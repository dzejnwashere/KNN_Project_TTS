...
output_dir = "/home/alex/Documents/KNN/baseline_data/surprised"

print("Loading fine-tuned FastPitch...")
spec_generator = FastPitchModel.restore_from(
    "/home/alex/Documents/KNN/models/new_surprised_fastpitch_finetuned.nemo"
).eval().cuda()

hifigan_path = "/home/alex/Documents/KNN/models/new_surprised_hifigan_finetuned.nemo"
if os.path.exists(hifigan_path):
    ...
    vocoder = HifiGanModel.restore_from(
        "/home/alex/Documents/KNN/tts_hifigan.nemo"
    ).eval().cuda()
